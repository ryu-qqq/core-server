...
public class ProductDelivery implements ItemDeliveryInfo, ItemRefundInfo {
	...
	private ProductDelivery(Long productGroupId, String deliveryArea, Money deliveryFee, int deliveryPeriodAverage,
	...
	public static ProductDelivery create(Long productGroupId, String deliveryArea, Money deliveryFee, int deliveryPeriodAverage,
										 ReturnMethod returnMethodDomestic, ShipmentCompanyCode returnCourierDomestic,
										 Money returnChargeDomestic, String returnExchangeAreaDomestic) {
		return new ProductDelivery(productGroupId, deliveryArea, deliveryFee, deliveryPeriodAverage,
			returnMethodDomestic, returnCourierDomestic, returnChargeDomestic, returnExchangeAreaDomestic);
	}

	public ProductDelivery assignProductGroupId(Long productGroupId) {
		return new ProductDelivery(productGroupId, this.deliveryArea, this.deliveryFee, this.deliveryPeriodAverage,
