...
public class DefaultUpdateProductGroupContextCommand implements ProductGroupContextCommand {
	...
	DefaultUpdateProductGroupContextCommand(
	...
	public static class Builder implements ProductGroupContextCommandBuilder {
		...
		public DefaultUpdateProductGroupContextCommand build() {
			return new DefaultUpdateProductGroupContextCommand(
		...
		public Optional<Long> getProductGroupId() {
			return Optional.of(productGroupId);
		}
