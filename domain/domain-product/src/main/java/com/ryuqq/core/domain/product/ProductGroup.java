...
public class ProductGroup implements Item {
	...
	private ProductGroup(Long id, long sellerId, long categoryId, long brandId, String productGroupName,
						 String styleCode,
	...
	public static ProductGroup create(Long id, long sellerId, long categoryId, long brandId, String productGroupName,
									  String styleCode,
	...
	public ProductGroup assignId(Long id) {
		return new ProductGroup(id, this.sellerId, this.categoryId, this.brandId,
	...
	public boolean equals(Object object) {
		...
		ProductGroup that = (ProductGroup) object;
		return sellerId
			== that.sellerId
			&& categoryId
			== that.categoryId
